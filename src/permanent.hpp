 ...
 *
 *
 * This is a wrapper around the templated function `hafnian::permanent` for Python
 ...
 *
 *
 * This is a wrapper around the templated function `hafnian::perm_fsum` for Python
 * integration. It accepts and returns double numeric types, and
 * returns sensible values for empty and non-even matrices.
 *
 *

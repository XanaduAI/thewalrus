...
#include <stdio.h>
void
evals (double complex z[], double vals[], int n)
{
  /*
     Calculates the eigenvalues of the hermitian n x n matrix z
     returns the (real) eigenvalues in the array vals
...
void
powtrace (double complex z[], int n, double traces[], int l)
{
  /*

...
void powtrace(double complex z[], int n, double traces[], int l){
  /*
...
double do_chunk(double complex mat[], int n, unsigned long long int X, unsigned long long int chunksize){
  /*
...
double dhafnian(double *mat, int n){

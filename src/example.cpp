...
int main() {
    ...
    std::vector<std::complex<double>> mat(16, std::complex<double>(1.0, 1.0));
    std::vector<int> rpt(4, 1);

    std::complex<double> hafval = hafnian::loop_hafnian_rpt(mat, rpt, true);
    std::cout << hafval << std::endl;

    std::cout << std::endl;

    hafval = hafnian::loop_hafnian_rpt(mat, rpt, false);
    std::cout << hafval << std::endl;

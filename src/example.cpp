...
int main() {
    ...
    std::vector<double> mat = {0, 1, 1, 0};
    std::vector<int> rpt = {6, 6};

    double hafval1 = hafnian::hafnian_rpt(mat, rpt, true);
    std::cout << "haf (eigen) = " << hafval1 << std::endl;

    double hafval2 = hafnian::hafnian_rpt(mat, rpt, false);
    std::cout << "haf (no eigen) = " << hafval2 << std::endl;

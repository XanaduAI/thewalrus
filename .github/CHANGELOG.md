...
* Removes an unnecessary vector in the calculation of hermite polynomials in `hermite_multidimensional.hpp`, improving the efficiency [#141](https://github.com/XanaduAI/thewalrus/pull/141)

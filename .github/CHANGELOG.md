...
* Entanglement measures `entanglement_entropy` and `log_negativity` for bipartite Gaussian states. [#332](https://github.com/XanaduAI/thewalrus/pull/322)
...
Jake Bulmer, Fabian Laudenbach, Gregory Morse

...
* Adds the function `hafnian_sample_graph_rank_one` in `thewalrus.samples` to sample from rank-one adjacency matrice. [#174](https://github.com/XanaduAI/thewalrus/pull/169)

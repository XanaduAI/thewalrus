 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_11 = __pyx_convert_vector_to_py___pyx_t_double_complex(libwalrus::hermite_multidimensional_cpp(__pyx_v_R_mat, __pyx_v_y_mat, __pyx_v_cutoff, __pyx_v_ren)); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 399, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_r = __pyx_t_11;
  __pyx_t_11 = 0;
  goto __pyx_L0;
